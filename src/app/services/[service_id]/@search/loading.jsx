      ...
      <div className="sticky top-0 min-h-full flex flex-col gap-4">
        ...
        <div className="w-full">
          ...
          <div className="relative inline-block w-full">
            <select
              className="block appearance-none w-full border border-gray-300 text-gray-700 py-2 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500 bg-gray-200 animate-pulse"
              // value={selectedBrand}
            >
